...
struct Context {
	...
	analysis: im::HashMap<tg::Id, Analysis>,

	// A cache of published packages that we know about.
	published_packages: im::HashMap<tg::package::Metadata, tg::Id>,
...
// #[async_recursion]
// async fn lock(context: &Context, solution: &Solution, package: tg::Id) -> Result<tg::Lock> {
...
// 		let packages = im::HashMap::new();
// 		let analysis = im::HashMap::new();
// 		Self {
// 			client,
...
// 	#[must_use]
// 	fn resolve_path_dependency(&self, dependant: &Dependant) -> Option<Result<tg::Id, Error>> {
// 		let Dependant {
// 			package,
// 			dependency,
// 		} = dependant;
...
// 	async fn analysis(&mut self, package: &tg::Id) -> Result<&'_ Analysis> {
...
// 	async fn dependencies(&mut self, package: &tg::Id) -> Result<&'_ [tg::Dependency]> {
// 		Ok(&self.analysis(package).await?.dependencies)
// 	}

// 	async fn version(&mut self, package: &tg::Id) -> Result<&str> {
...
// impl Analysis {
// 	pub async fn new(client: &dyn tg::Client, artifact: tg::Artifact) -> Result<Self> {
// 		let id = artifact
// 			.id(client)
// 			.await
