use crate::nfs::{
	...
	types::{
		...
		specdata4, GETATTR4args, GETATTR4res, GETATTR4resok, FATTR4_ACL, FATTR4_ACLSUPPORT,
		FATTR4_ARCHIVE, FATTR4_CANSETTIME, FATTR4_CASE_INSENSITIVE, FATTR4_CASE_PRESERVING,
		FATTR4_CHANGE, FATTR4_CHANGE_POLICY, FATTR4_CHOWN_RESTRICTED, FATTR4_DACL,
		FATTR4_DIRENT_NOTIF_DELAY, FATTR4_DIR_NOTIF_DELAY, FATTR4_FH_EXPIRE_TYPE,
		FATTR4_FILEHANDLE, FATTR4_FILEID, FATTR4_FILES_AVAIL, FATTR4_FILES_FREE,
		FATTR4_FILES_TOTAL, FATTR4_FSID, FATTR4_FS_CHARSET_CAP, FATTR4_FS_LAYOUT_TYPE,
		FATTR4_FS_LOCATIONS, FATTR4_FS_LOCATIONS_INFO, FATTR4_FS_STATUS, FATTR4_HIDDEN,
		FATTR4_HOMOGENEOUS, FATTR4_LAYOUT_ALIGNMENT, FATTR4_LAYOUT_BLKSIZE, FATTR4_LAYOUT_HINT,
		FATTR4_LAYOUT_TYPE, FATTR4_LEASE_TIME, FATTR4_LINK_SUPPORT, FATTR4_MAXFILESIZE,
		FATTR4_MAXLINK, FATTR4_MAXNAME, FATTR4_MAXREAD, FATTR4_MAXWRITE, FATTR4_MDSTHRESHOLD,
		FATTR4_MIMETYPE, FATTR4_MODE, FATTR4_MODE_SET_MASKED, FATTR4_MOUNTED_ON_FILEID,
		...
		FATTR4_RDATTR_ERROR, FATTR4_RETENTEVT_GET, FATTR4_RETENTEVT_SET, FATTR4_RETENTION_GET,
		FATTR4_RETENTION_HOLD, FATTR4_RETENTION_SET, FATTR4_SACL, FATTR4_SIZE, FATTR4_SPACE_AVAIL,
		FATTR4_SPACE_FREE, FATTR4_SPACE_TOTAL, FATTR4_SPACE_USED, FATTR4_SUPPATTR_EXCLCREAT,
		FATTR4_SUPPORTED_ATTRS, FATTR4_SYMLINK_SUPPORT, FATTR4_SYSTEM, FATTR4_TIME_ACCESS,
		FATTR4_TIME_ACCESS_SET, FATTR4_TIME_BACKUP, FATTR4_TIME_CREATE, FATTR4_TIME_DELTA,
		FATTR4_TIME_METADATA, FATTR4_TIME_MODIFY, FATTR4_TIME_MODIFY_SET, FATTR4_TYPE,
		FATTR4_UNIQUE_HANDLES, MODE4_RGRP, MODE4_RUSR, MODE4_XGRP, MODE4_XUSR, pathname4,
	},
	xdr, Context, Server,
};
use num::ToPrimitive;
...
impl FileAttrData {
	fn to_bytes(&self, requested: &bitmap4) -> Vec<u8> {
		...
		for attr in ALL_SUPPORTED_ATTRS.iter().copied() {
			...
			// }
			match attr {
				SUPPORTED_ATTRS => encoder.encode(&self.supported_attrs.0).unwrap(),
